<%@page contentType="text/html;charset=UTF-8" language="java" %>
  <%@page isELIgnored="false" %>
            ...
            * {
            ...
            .hero {
              ...
              background: linear-gradient(135deg,
                ...
                url("https://images.unsplash.com/photo-1487070183336-b863922373d4?w=1600") center/cover;

              overflow: hidden;
            }

            /* Ambient Dreamy Background Flowers */
            .hero-bg-flower {
              position: absolute;
              top: -10%;
              left: -10%;
              right: -10%;
              bottom: -10%;
              background-image: url("https://images.unsplash.com/photo-1519225495810-7517c24a9e59?q=80&w=1600&auto=format&fit=crop");
            ...
            .btn-primary {
              ...
              color: #FAF5EF;
              box-shadow: 0 10px 30px rgba(60, 41, 34, 0.15);
            }
            ...
            .btn-primary:hover {
              ...
              box-shadow: 0 15px 35px rgba(170, 106, 63, 0.25);
            }

            .btn-secondary {
              background: transparent;
              color: var(--brown-main);
              border: 1.5px solid rgba(60, 41, 34, 0.25);
            }

            .btn-secondary:hover {
              background: rgba(60, 41, 34, 0.04);
            ...
            .hero-card {
              ...
              border-radius: 28px;
              overflow: hidden;
              box-shadow: 0 25px 60px rgba(60, 41, 34, 0.1);
              position: relative;
            ...
            .carousel-btn {
              ...
              box-shadow: 0 8px 32px rgba(60, 41, 34, 0.05);
              outline: none;
            }
            ...
            .carousel-btn:hover {
              ...
              box-shadow: 0 8px 32px rgba(60, 41, 34, 0.1);
            }
            ...
            /* Glassmorphic Product Card Overlay inside Carousel */
            .carousel-product-card {
              ...
              gap: 0.5rem;
              z-index: 5;
              box-shadow: 0 15px 35px rgba(60, 41, 34, 0.08);
              transition: all 0.5s cubic-bezier(0.25, 1, 0.5, 1);
              transform: translateY(10px);
              opacity: 0;
            }

            .carousel-slide.active .carousel-product-card {
          ...
          <script type="application/ld+json">
      {
        ...
        <body id="wandave-theme" class="index" data-theme="tbag-fashion">
          ...
          <nav id="menu-mobile" class="hidden-md">
            ...
            <ul class="list-lang">
              <li class="btn-language-vi" title="Vietnamese">
                <a href="#" onclick="doGTranslate('vi|vi');return false;" title="" class="lang-vi gflag vietnam nturl"
              ...
              <li class="btn-language-en" title="English">
                <a href="#" onclick="doGTranslate('vi|en');return false;" title="" class="lang-en gflag nturl"
              ...
              <li class="btn-language-ko" title="Korean">
                <a href="#" onclick="doGTranslate('vi|ko');return false;" title="" class="lang-ko gflag nturl"
          ...
          <%@ include file="partials/header.jsp" %>
            ...
            <main>
              <section class="hero">
                <div class="hero-bg-flower"></div>
                <div class="hero-container">
                  <div class="hero-content">
                    <div class="hero-text animate">
                      <h1>Tiệm Hoa Nhà Tớ</h1>

                      <p class="hero-subtitle">Thiết kế bó hoa mang dấu ấn riêng của bạn.</p>

                      <div class="hero-buttons">
                        <a href="${pageContext.request.contextPath}/custom-bouquet" class="btn btn-primary">
                          Custom bó hoa ngay
                          <span>→</span>
                        </a>
                    ...
                    <div class="hero-image-column animate">
                      <div class="hero-card-wrapper">
                        <div class="hero-card">
                          <div class="hero-carousel" id="heroCarousel">
                                  ...
                                  <c:when test="${not empty bestSellerProducts}">
                                    <c:forEach var="product" items="${bestSellerProducts}" varStatus="status">
                                      <c:if test="${status.index < 4}">
                                        <li class="carousel-slide ${status.first ? 'active' : ''}">
                                          <img class="carousel-image"
                                            src="${product.image != null ? product.image : 'https://via.placeholder.com/400x500?text=No+Image'}"
                                          ...
                                          <div class="carousel-product-card">
                                            ...
                                            <div class="carousel-product-bottom">
                                              <span class="carousel-product-price">
                                                <c:choose>
                                  ...
                                  <c:otherwise>
                                    ...
                                    <li class="carousel-slide active">
                                      <img class="carousel-image"
                                        ...
                                        alt="Pure Blossom">
                                      <div class="carousel-product-card">
                                        <h3 class="carousel-product-title">Pure Blossom</h3>
                                        <div class="carousel-product-bottom">
                                          <span class="carousel-product-price">1,200,000 VND</span>
                                          <a href="${pageContext.request.contextPath}/products/pure-blossom"
                                            class="carousel-detail-btn">
                                            Chi tiết
                                    ...
                                    <li class="carousel-slide">
                                      <img class="carousel-image"
                                        ...
                                        alt="Peachy Dream">
                                      <div class="carousel-product-card">
                                        <h3 class="carousel-product-title">Peachy Dream</h3>
                                        <div class="carousel-product-bottom">
                                          <span class="carousel-product-price">1,500,000 VND</span>
                                          <a href="${pageContext.request.contextPath}/products/peachy-dream"
                                            class="carousel-detail-btn">
                                            Chi tiết
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                              <path d="M5 12h14M12 5l7 7-7 7" stroke-linecap="round"
                                    ...
                                    <li class="carousel-slide">
                                      <img class="carousel-image"
                                        src="https://images.unsplash.com/photo-1562240020-ce31ccb0fa7d?q=80&w=800&auto=format&fit=crop"
                                        alt="White Tulip">
                                      <div class="carousel-product-card">
                                        <h3 class="carousel-product-title">White Tulip</h3>
                                        <div class="carousel-product-bottom">
                                          <span class="carousel-product-price">850,000 VND</span>
                                          <a href="${pageContext.request.contextPath}/products/white-tulip"
                                            class="carousel-detail-btn">
                                            Chi tiết
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                              <path d="M5 12h14M12 5l7 7-7 7" stroke-linecap="round"
                                    ...
                                    <li class="carousel-slide">
                                      <img class="carousel-image"
                                        ...
                                        alt="Creamy Soft">
                                      <div class="carousel-product-card">
                                        <h3 class="carousel-product-title">Creamy Soft</h3>
                                        <div class="carousel-product-bottom">
                                          <span class="carousel-product-price">1,600,000 VND</span>
                                          <a href="${pageContext.request.contextPath}/products/creamy-soft"
                                            class="carousel-detail-btn">
                                            Chi tiết
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                              <path d="M5 12h14M12 5l7 7-7 7" stroke-linecap="round"
                            ...
                            <button class="carousel-btn carousel-btn-next" id="carouselNextBtn" aria-label="Next slide">
                              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                        ...
                        <div class="carousel-nav" id="carouselNav">
                          <c:choose>
                            <c:when test="${not empty bestSellerProducts}">
                              <c:forEach var="product" items="${bestSellerProducts}" varStatus="status">
                                <c:if test="${status.index < 4}">
                                  <button class="carousel-indicator ${status.first ? 'active' : ''}"
                ...
                <div class="container">
                  ...
                  <div class="categories-grid">
                    <c:forEach var="category" items="${featuredCategories}">
                      <a href="${pageContext.request.contextPath}/products/category/${category.slug}"
                    ...
                    <c:if test="${empty featuredCategories}">
                      ...
                      <div class="category-card animate">
                        <img src="https://file.hstatic.net/200000846175/file/d7a376e45096e9c8b087-min.jpg"
                          alt="Hoa Tulip" />
                        <div class="category-overlay">
                ...
                <div class="container">
                  ...
                  <div class="products-grid">
                    <c:forEach var="product" items="${bestSellerProducts}">
                      <a href="${pageContext.request.contextPath}/products/${product.slug}" class="product-card animate"
                        ...
                        <div class="product-image">
                          ...
                          <c:if test="${product.salePrice != null && product.salePrice > 0}">
                            <span class="product-badge">-
                              <fmt:formatNumber value="${(1 - product.salePrice / product.price) * 100}"
                                maxFractionDigits="0" />%
                            </span>
                          </c:if>
              ...
              <section class="instagram">
                <div class="container">
                  ...
                  <div class="instagram-grid">
                    ...
                    <div class="instagram-item animate">
                      <img src="https://images.unsplash.com/photo-1487070183336-b863922373d4?w=400" alt="Instagram 8" />
            ...
            <%@ include file="partials/footer.jsp" %>
              ...
              <div class="social-fixed">
                <ul class="active overflow-active">
                  ...
                  <li class="">
                    <a href="https://www.messenger.com/login.php?next=https%3A%2F%2Fwww.messenger.com%2Ft%2Ftiemhoa.lavieestbelle"
    ...
    `;
                ...
                // Premium Hero Carousel Controller
                document.addEventListener("DOMContentLoaded", () => {
                  ...
                  let currentIndex = 0;
                  let slideInterval;
                  const intervalTime = 4500; // 4.5 seconds for gentle browsing
